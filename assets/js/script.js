...
alert("At least a minimum of 8 characters (and up to 128 characters).");
alert("At least one of the following: uppercase, lowercase, numeric, or special characters.")
